                ...
                <div className="space-y-3 pt-2">
                  ...
                  <div className="text-center">
                    <button
                      ...
                      onClick={(e) => {
                        const msg = formatLeadToWhatsAppMessage({
                          firstName: indForm.firstName,
                          lastName: indForm.lastName,
                          companyName: indForm.companyName,
                          email: indForm.email,
                          phone: indForm.phone,
                          website: indForm.website,
                          industry: config.title,
                          services: indForm.services,
                          adBudget: indForm.adBudget,
                          projectDescription: indForm.projectDescription
                        });
                    ...
                    >
                      ...
                      <span>Or Send Inquiry via WhatsApp</span>
                    </button>
                  </div>
                </div>
              ...
              <div className="bg-[#121212] text-white p-6 sm:p-8 rounded-2xl border-2 border-[#a3e6cd] shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                  <a
                    ...
                    rel="noopener noreferrer"
                    onClick={(e) => {
                      const msg = `Hi Deon, I'm booking an automation strategy session for ${config.title} and want to connect on WhatsApp.`;
                      openWhatsAppChat(msg, e);
                    }}
