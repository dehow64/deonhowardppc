  ...
  return (
    <section className="bg-[#9ce2c7] py-16 md:py-24 border-b border-[#8bd6ba]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 rounded-3xl overflow-hidden shadow-2xl border border-white/60">
          ...
          <div className="lg:col-span-6 relative min-h-[320px] lg:min-h-[440px]">
            ...
            />
            <div className="absolute inset-0 bg-[#131d17]/30"></div>
          </div>
